...
const iosTransitionAnimation = () => Promise.resolve().then(function () { return require('./ios.transition-6AFNO6uU.js'); });
const mdTransitionAnimation = () => Promise.resolve().then(function () { return require('./md.transition-CPq0ckrU.js'); });
