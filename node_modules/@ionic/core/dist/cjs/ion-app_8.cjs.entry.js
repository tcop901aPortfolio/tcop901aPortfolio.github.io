...
var hardwareBackButton = require('./overlays-DwMDYc_O.js');
...
var index$1 = require('./index-BLq7TkUV.js');
var keyboardController = require('./keyboard-controller-DaUNT15d.js');
var cubicBezier = require('./cubic-bezier-DAjy1V-e.js');
var frameworkDelegate = require('./framework-delegate-DYIuFqQx.js');
var lockController = require('./lock-controller-aDB9wrEf.js');
var index$2 = require('./index-D_D542p0.js');
require('./gesture-controller-CeJslptU.js');
require('./keyboard-DstMw6u1.js');
require('./capacitor-cADDPMtd.js');
    ...
    componentDidLoad() {
        {
            this.rIC(async () => {
                ...
                if (!index.config.getBoolean('_testing')) {
                    Promise.resolve().then(function () { return require('./index-B-R-H1Z2.js'); }).then((module) => module.startTapClick(index.config));
                }
                if (index.config.getBoolean('statusTap', isHybrid)) {
                    Promise.resolve().then(function () { return require('./status-tap-BUfv_eD4.js'); }).then((module) => module.startStatusTap());
                }
                if (index.config.getBoolean('inputShims', needInputShims())) {
                    ...
                    Promise.resolve().then(function () { return require('./input-shims-DYxL0Fdm.js'); }).then((module) => module.startInputShims(index.config, platform));
                }
                const hardwareBackButtonModule = await Promise.resolve().then(function () { return require('./overlays-DwMDYc_O.js'); }).then(function (n) { return n.hardwareBackButton; });
                ...
                if (typeof window !== 'undefined') {
                    Promise.resolve().then(function () { return require('./keyboard-BJEm-3HF.js'); }).then((module) => module.startKeyboardAssist(window));
                }
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        ...
        this.gesture = (await Promise.resolve().then(function () { return require('./swipe-back-DYKxJU5r.js'); })).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => this.ani?.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
                this.ani.onFinish(() => {
                    this.gestureOrAnimationInProgress = false;
                    if (this.swipeHandler) {
