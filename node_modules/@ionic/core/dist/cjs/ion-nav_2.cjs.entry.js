...
var index$1 = require('./index-D_D542p0.js');
...
const Nav = class {
    ...
    async componentDidLoad() {
        ...
        this.didLoad = true;
        this.rootChanged();
        this.gesture = (await Promise.resolve().then(function () { return require('./swipe-back-DYKxJU5r.js'); })).createSwipeBackGesture(this.el, this.canStart.bind(this), this.onStart.bind(this), this.onMove.bind(this), this.onEnd.bind(this));
