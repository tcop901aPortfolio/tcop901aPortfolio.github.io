 ...
 */
import { r as registerInstance, e as config, f as printIonWarning, h, d as Host, g as getElement, c as createEvent, a as readTask, i as forceUpdate, w as writeTask, j as printIonError } from './index-Dvqtt_WK.js';
import { v as shouldUseCloseWatcher, n as getOverlaySizeType } from './overlays-a_5AhqWk.js';
import { a as isPlatform, b as getIonMode } from './ionic-global-BSaFA7np.js';
import { i as inheritAriaAttributes, h as hasLazyBuild, c as componentOnReady, e as clamp, u as shallowEqualStringMap } from './helpers-BJFnZngp.js';
import { i as isRTL } from './dir-Dojwmvde.js';
import { h as hostContext, c as createColorClasses } from './theme-byZM6qHV.js';
import { b as findIonContent, p as printIonContentErrorMsg, g as getScrollElement } from './index-obGyiHiO.js';
import { c as createKeyboardController } from './keyboard-controller-BLvRgxgP.js';
import { g as getTimeGivenProgression } from './cubic-bezier-hHmYLOfE.js';
import { a as attachComponent, d as detachComponent } from './framework-delegate-CUDbUfWS.js';
import { c as createLockController } from './lock-controller-B-hirT0v.js';
import { t as transition } from './index-CdoVp_rZ.js';
import './gesture-controller-B_gJaBk0.js';
import './keyboard-Cz4hUjuj.js';
import './capacitor-C041I3qZ.js';
    ...
    componentDidLoad() {
        {
            this.rIC(async () => {
                ...
                if (!config.getBoolean('_testing')) {
                    import('./index-DoY4e_3F.js').then((module) => module.startTapClick(config));
                }
                if (config.getBoolean('statusTap', isHybrid)) {
                    import('./status-tap-BsTKKfug.js').then((module) => module.startStatusTap());
                }
                if (config.getBoolean('inputShims', needInputShims())) {
                    ...
                    import('./input-shims-DognYvwv.js').then((module) => module.startInputShims(config, platform));
                }
                const hardwareBackButtonModule = await import('./overlays-a_5AhqWk.js').then(function (n) { return n.w; });
                ...
                if (typeof window !== 'undefined') {
                    import('./keyboard-Dsc85bts.js').then((module) => module.startKeyboardAssist(window));
                }
...
const RouterOutlet = class {
    ...
    async connectedCallback() {
        ...
        this.gesture = (await import('./swipe-back-ibFGqXH2.js')).createSwipeBackGesture(this.el, () => !this.gestureOrAnimationInProgress && !!this.swipeHandler && this.swipeHandler.canStart(), () => onStart(), (step) => this.ani?.progressStep(step), (shouldComplete, step, dur) => {
            if (this.ani) {
                this.ani.onFinish(() => {
                    this.gestureOrAnimationInProgress = false;
                    if (this.swipeHandler) {
