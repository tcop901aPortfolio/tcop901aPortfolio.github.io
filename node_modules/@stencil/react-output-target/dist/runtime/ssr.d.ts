...
type CreateComponentForSSROptions<I extends HTMLElement, E extends EventNames = {}, C = Omit<I, keyof HTMLElement>, R extends keyof C = never> = Omit<CreateComponentForServerSideRenderingOptions, 'renderToString' | 'transformTag'> & {
 ...
 * @public
 */
export declare const createComponent: <I extends HTMLElement, E extends EventNames = {}, C = Omit<I, keyof HTMLElement>, R extends keyof C = never>(options: CreateComponentForSSROptions<I, E, C, R>) => StencilReactComponent<I, E, C, R>;
