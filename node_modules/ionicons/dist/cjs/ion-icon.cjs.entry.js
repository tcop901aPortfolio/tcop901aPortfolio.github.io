...
var index$1 = require('./index-4_Berl5e.js');
var index = require('./index-tkr2PTVD.js');
...
const Icon = class {
    ...
    render() {
        ...
        return (index$1.h(index$1.Host, Object.assign({ key: '0578c899781ca145dd8205acd9670af39b57cf2e', role: "img", class: Object.assign(Object.assign({ [mode]: true }, createColorClasses(this.color)), { [`icon-${this.size}`]: !!this.size, 'flip-rtl': shouldBeFlippable, 'icon-rtl': shouldBeFlippable && index.isRTL(el) }) }, inheritedAttributes), this.svgContent ? (index$1.h("div", { class: "icon-inner", innerHTML: this.svgContent })) : (index$1.h("div", { class: "icon-inner" }, index$1.h("slot", null)))));
    }
